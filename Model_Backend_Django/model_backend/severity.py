def calculate_average(lst,glob_high,glob_medium,glob_low):
    ...
    if high > medium and high > low:
        # print("high")
        severity="high"
        glob_high = glob_high + 1
    elif medium > high and medium > low:
        # print("medium")
        severity="medium"
        glob_medium = glob_medium + 1
    else:
        # print("low")
        severity="low"
        glob_low = glob_low + 1
    ...
    return distress,value,severity,glob_high,glob_medium,glob_low
